...
export type EventType =
  ...
  | 'FORGE_PAGE_VIEWED'
  | 'FORGE_RESUME_UPLOADED'
  | 'FORGE_RESUME_PARSED'
  | 'FORGE_ANALYSIS_STARTED'
  | 'FORGE_ANALYSIS_COMPLETED'
  | 'FORGE_ANALYSIS_FAILED'
  | 'FORGE_OUTPUT_DELIVERED'
  // Consumer: Refinery
  | 'REFINERY_ARTIFACT_CREATED'
  | 'REFINERY_ARTIFACT_UPDATED'
  | 'REFINERY_ARTIFACT_DOWNLOADED'
