...
> **NEW CHAT: START HERE ->** `docs/FABLE-REASSESSMENT-AGENCY-2026-06-10.md` (direction: t.ROY agency + unified platform + seats model + revised Aug-14 runway; contains Troy's recorded decisions) **then** `docs/FABLE-ANALYSIS-REPORT-2026-06-09.md` -- the full-platform bug/gap analysis after Troy's 2026-06-09 end-to-end test (Fable session). It contains the prioritized fix list: **P0 = truth-gate the two document-generation prompts (resume-generate-full + generate-docs both instruct the model to ESTIMATE numbers -- artifact-proven fabrications) and shared-IP rate limits before the EXPO of Wisconsin cohort (week of 2026-06-16)**, then the P1 artifact-layer fixes (identity desync + contact clobber, certifications field, Tailor must load the structured base resume, PDF pipeline, export footer disclosure leak, missing legal disclaimer). Troy's asks: live voice in the disclosure planner (stack proven, ~1 day), job-board fine-tuning filters + honest fair-chance badges, population-fit pass. Charter was `docs/HANDOFF-FABLE-FULL-FLOW-ANALYSIS-2026-06-09.md`; Phase 7 baseline `docs/PHASE-7-ANALYSIS-2026-06-09.md`. (Prior live-cutover context: `docs/HANDOFF-2026-06-07-SESSION-CLOSE-LIVE.md`.)
