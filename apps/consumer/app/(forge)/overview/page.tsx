...
const JOURNEY = [
  ...
  },
  {
    ...
    time: "5 minutes",
    what: "Fill in your contact info. Search real listings from several job sources. Employers we checked for hiring people with records are marked, and each mark shows where it applies.",
    tech: "Each mark rests on dated evidence in the employer directory (Neon PostgreSQL) that expires on its own, and it applies only where the evidence was found. No AI summary can grant a mark.",
    color: "phos",
  },
  {
    stage: "Stage 3",
